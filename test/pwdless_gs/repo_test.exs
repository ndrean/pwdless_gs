defmodule PwdlessGs.RepoTest do
  ...
  describe ".init/1" do
    ...
    test "check the repo initial state" do
      map = :sys.get_state(Pwdless_gs.Repo)
      assert ["bar@email.com", "baz@email.com", "foo@email.com"] == Map.keys(map)
    end
